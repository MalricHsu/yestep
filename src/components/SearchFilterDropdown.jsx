...
const SearchFilterDropdown = ({ label, selectedValues, apiKey, onCheckboxChange }) => {
    ...
    return (
        <div className="dropdown">
            ...
            <ul
                className="dropdown-menu py-2 shadow mt-2"
                style={isGrid ? { minWidth: '240px' } : {}}
            >
                            ...
                            <div className={isGrid ? 'col py-2' : 'py-2'} key={option}>
                                <div className="form-check d-flex align-items-center">
                                    <input
                                        ...
                                        onChange={() =>
                                            onCheckboxChange(apiKey, option, selectedValues)
                                        }
                                    />
                                    <label
                                        className="form-check-label text-black-700 w-100 ms-2"
                                        htmlFor={inputId}
                                    >
                                        {option}
                                    </label>
