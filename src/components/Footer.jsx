          ...
          <div className="row row-gap-6">
            ...
            <div className="col-lg-5">
              <div className="brand__logo d-flex flex-column align-items-center align-items-lg-start mb-6 mb-sm-13">
                ...
                >
                  ...
                  <img className="logo-yestep" src={yestepWhite} alt="footer logo圖" />
                </Link>
                <p className="brand__logo-slogan text-black-100">每一步，找回生活的呼吸</p>
              </div>
            ...
            <div className="col-lg-7">
              <ul className="footer__icons list-unstyled d-flex justify-content-center justify-content-lg-end gap-3 mb-5">
                <li>
                  <a href="https://www.facebook.com/" target="_blank" className="text-white p-2">
                    <img src={iconFacebook} alt="facebook icon" />
                  </a>
                </li>
                <li>
                  <a href="https://www.line.me/" target="_blank" className="text-white p-2">
                    <img src={iconLine} alt="line icon" />
                  </a>
                </li>
                <li>
                  <a href="https://www.instagram.com/" target="_blank" className="text-white p-2">
                    <img src={iconInstagram} alt="instagram icon" />
                  </a>
                </li>
                <li>
                  <a href="https://www.threads.com/" target="_blank" className="text-white p-2">
