...
function ThemeSwiper() {
            ...
            <div className="theme ">
              <div className="theme__img">
                <picture>
                  ...
                  {/* 預設 (手機版) 顯示 image */}
                  <img src={item.image} className="w-100 object-fit-cover " alt={item.title} />
                </picture>
              </div>
              <picture>
              ...
              <div className="theme__content w-100">
                <div className="row ">
                  <div className="col-lg-8">
                    <h3 className="fs-lg-1 fs-4 text-primary-300 mb-4">04 April</h3>
                    <div
  ...
  align-items-lg-center  gap-6 p-6 bg-white rounded-24"
                    >
                      <div>
                        <h5 className="fs-5 mb-3 text-primary-300 ">{item.title}</h5>
                        <p className="text-black-700">{item.derscription}</p>
                      </div>
                      <Link
                        to="/theme"
