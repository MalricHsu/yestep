  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: 'linear-gradient(to right, rgba(44, 46, 48, 0.3), rgba(44, 46, 48, 0.1))',
        }}
      ></div>
      ...
      <div className="container position-relative z-1">
        <div className="row justify-content-center align-items-center flex-row-reverse">
          ...
          <div className="col-11 col-sm-8 col-md-6 col-lg-5 col-xl-4">
            ...
            >
              <h3 className="fs-5 text-white text-center mb-4 fw-bold ls-2">踏出第一步</h3>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-floating mb-3">
                  ...
                  {errors.username && (
                    <div className="invalid-feedback text-red">{errors.username.message}</div>
                  )}
                </div>
                ...
                <div className="d-flex justify-content-center align-items-center mt-3 border-top border-primary-100 border-opacity-25 pt-4">
                  <Link to="/login" className="text-white fw-bold text-decoration-none small">
                    已經有帳號？
                    <span className="border-bottom border-primary-100 pb-1">在此登入</span>
                  </Link>
                </div>
              </form>
            </div>
