...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      dispatch(createMessage({ text, type: 'red' }));
    }
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: 'linear-gradient(to right, rgba(44, 46, 48, 0.15), rgba(44, 46, 48, 0.05))',
        }}
      ></div>
      <div className="container position-relative z-1">
        <div className="row justify-content-center align-items-center">
          ...
          <div className="col-11 col-sm-8 col-md-6 col-lg-5 col-xl-4">
            ...
            >
              <h3 className="fs-5 text-white text-center mb-4 fw-bold ls-2">啟程登入</h3>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="d-flex justify-content-center align-items-center mt-4">
                  <Link to="/" className="text-white fw-bold text-decoration-none small">
                    <i className="bi bi-arrow-left me-2"></i>
                    <span className="border-bottom border-primary-100 pb-1 me-1">首頁</span>｜
                  </Link>

                  <div className="ms-2 d-flex align-items-center gap-3">
                    <Link to="/register" className="text-white fw-bold text-decoration-none small">
                      還沒有帳號嗎？
                      <span className="border-bottom border-primary-100 pb-1 ms-1">在此註冊</span>
                    </Link>
                  </div>
                </div>
              </form>
